...
public class RoleAuthorityMappingApi extends BaseController<RoleAuthorityMappingPO, RoleAuthorityMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@Validated({IInsert.class,Default.class}) @RequestBody RoleAuthorityMappingPO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@Validated({IUpdate.class,Default.class}) @RequestBody RoleAuthorityMappingPO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("list")
    public CommonResult<List<RoleAuthorityMappingPO>> list(@Validated({IList.class}) RoleAuthorityMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<RoleAuthorityMappingVO>> listRoleAuthorityMappingVO(@Validated({IList.class}) @ModelAttribute("pojo")RoleAuthorityMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
