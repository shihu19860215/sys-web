...
public class TenantSystemMappingApi extends BaseController<TenantSystemMappingPO, TenantSystemMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody TenantSystemMappingPO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@RequestBody TenantSystemMappingPO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<TenantSystemMappingVO>> listTenantSystemMappingVO(@ModelAttribute("pojo")TenantSystemMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
