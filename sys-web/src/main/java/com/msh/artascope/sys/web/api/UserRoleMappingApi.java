...
public class UserRoleMappingApi extends BaseController<UserRoleMappingPO, UserRoleMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@Validated({IInsert.class,Default.class}) @RequestBody UserRoleMappingPO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@Validated({IUpdate.class,Default.class}) @RequestBody UserRoleMappingPO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("list")
    public CommonResult<List<UserRoleMappingPO>> list(@Validated({IList.class}) UserRoleMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<UserRoleMappingVO>> listUserRoleMappingVO(@Validated({IList.class}) @ModelAttribute("pojo")UserRoleMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
