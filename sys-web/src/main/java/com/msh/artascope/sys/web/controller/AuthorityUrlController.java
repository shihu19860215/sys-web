...
public class AuthorityUrlController extends BaseController<AuthorityUrlPO, AuthorityUrlQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@Validated({IInsert.class,Default.class}) @RequestBody AuthorityUrlPO t) {
        return authorityUrlService.insert(t);
    }

    @ApiOperation(value = "通用删除逻辑", httpMethod = "POST", notes = "通用删除逻辑")
    @PostMapping("delete")
    public CommonResult delete(@Validated({IDelete.class,Default.class}) @RequestBody AuthorityUrlQO q) {
        return authorityUrlService.delete(q);
    }

    @ApiOperation(value = "逻辑删除", httpMethod = "POST", notes = "逻辑删除")
    @PostMapping("logicdelete")
    public CommonResult logicDelete(@Validated({IDelete.class,Default.class}) @RequestBody AuthorityUrlQO q) {
        return authorityUrlService.logicDelete(q);
    }

    @ApiOperation(value = "通用更新逻辑", httpMethod = "POST", notes = "通用更新逻辑")
    @PostMapping("update")
    public CommonResult update(@Validated({IUpdate.class,Default.class}) @RequestBody AuthorityUrlPO t) {
    ...
    @PostMapping("get")
    public CommonResult<AuthorityUrlPO> get(@Validated({IGet.class,Default.class}) @RequestBody AuthorityUrlQO q) {
        return authorityUrlService.get(q);
    }

    @ApiOperation(value = "通用查询逻辑", httpMethod = "POST", notes = "通用查询逻辑")
    @PostMapping("list")
    public CommonResult<List<AuthorityUrlPO>> list(@Validated({IList.class,Default.class}) @RequestBody AuthorityUrlQO q) {
