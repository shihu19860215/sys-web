...
public class UserSystemMappingApi extends BaseController<UserSystemMappingPO, UserSystemMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody UserSystemMappingPO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@RequestBody UserSystemMappingPO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<UserSystemMappingVO>> listUserSystemMappingVO(@ModelAttribute("pojo")UserSystemMappingQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
