...
public class DemoApi extends BaseController<DemoPO, DemoQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody DemoPO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@RequestBody DemoPO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<DemoVO>> listDemoVO(@ModelAttribute("pojo")DemoQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
