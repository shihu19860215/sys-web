...
public class AuditConfigureController extends BaseController<AuditConfigurePO, AuditConfigureQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@Validated({IInsert.class,Default.class}) @RequestBody AuditConfigurePO t) {
        return auditConfigureService.insert(t);
    }

    @ApiOperation(value = "通用删除逻辑", httpMethod = "POST", notes = "通用删除逻辑")
    @PostMapping("delete")
    public CommonResult delete(@Validated({IDelete.class,Default.class}) @RequestBody AuditConfigureQO q) {
        return auditConfigureService.delete(q);
    }

    @ApiOperation(value = "逻辑删除", httpMethod = "POST", notes = "逻辑删除")
    @PostMapping("logicdelete")
    public CommonResult logicDelete(@Validated({IDelete.class,Default.class}) @RequestBody AuditConfigureQO q) {
        return auditConfigureService.logicDelete(q);
    }

    @ApiOperation(value = "通用更新逻辑", httpMethod = "POST", notes = "通用更新逻辑")
    @PostMapping("update")
    public CommonResult update(@Validated({IUpdate.class,Default.class}) @RequestBody AuditConfigurePO t) {
    ...
    @PostMapping("get")
    public CommonResult<AuditConfigurePO> get(@Validated({IGet.class,Default.class}) @RequestBody AuditConfigureQO q) {
        return auditConfigureService.get(q);
    }

    @ApiOperation(value = "通用查询逻辑", httpMethod = "POST", notes = "通用查询逻辑")
    @PostMapping("list")
    public CommonResult<List<AuditConfigurePO>> list(@Validated({IList.class,Default.class}) @RequestBody AuditConfigureQO q) {
