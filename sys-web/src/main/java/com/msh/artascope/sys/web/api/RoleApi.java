...
public class RoleApi extends BaseController<RolePO, RoleQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody RolePO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@RequestBody RolePO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("list")
    public CommonResult<List<RolePO>> list(RoleQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<RoleVO>> listRoleVO(@ModelAttribute("pojo")RoleQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
