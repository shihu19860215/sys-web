...
public class UserRoleMappingController extends BaseController<UserRoleMappingPO, UserRoleMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody UserRoleMappingPO t) {
        return userRoleMappingService.insert(t);
    }

    @ApiOperation(value = "通用删除逻辑", httpMethod = "GET", notes = "通用删除逻辑")
    @PostMapping("delete")
    public CommonResult delete(UserRoleMappingQO q) {
        return userRoleMappingService.delete(q);
    }

    @ApiOperation(value = "逻辑删除", httpMethod = "GET", notes = "逻辑删除")
    @PostMapping("logicdelete")
    public CommonResult logicDelete(UserRoleMappingQO q) {
        return userRoleMappingService.logicDelete(q);
    }

    @ApiOperation(value = "通用更新逻辑", httpMethod = "POST", notes = "通用更新逻辑")
    @PostMapping("update")
    public CommonResult update(@RequestBody UserRoleMappingPO t) {
    ...
    @PostMapping("get")
    public CommonResult<UserRoleMappingPO> get(UserRoleMappingQO q) {
