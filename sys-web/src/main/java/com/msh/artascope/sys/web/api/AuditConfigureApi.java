...
public class AuditConfigureApi extends BaseController<AuditConfigurePO, AuditConfigureQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@Validated({IInsert.class,Default.class}) @RequestBody AuditConfigurePO p) {
    ...
    @PostMapping("update")
    public CommonResult update(@Validated({IUpdate.class,Default.class}) @RequestBody AuditConfigurePO p) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        p.setTenantId(tenantId);
        Long userId = HttpServletRequestUtil.getUserId();
        p.setOperatorId(userId);
    ...
    @GetMapping("list")
    public CommonResult<List<AuditConfigurePO>> list(@Validated({IList.class}) AuditConfigureQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
    ...
    @GetMapping("listvo")
    public CommonResult<List<AuditConfigureVO>> listAuditConfigureVO(@Validated({IList.class}) @ModelAttribute("pojo")AuditConfigureQO q) {
        Long tenantId = HttpServletRequestUtil.getTenantId();
        q.setTenantId(tenantId);
