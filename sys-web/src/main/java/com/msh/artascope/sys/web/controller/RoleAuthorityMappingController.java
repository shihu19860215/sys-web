...
public class RoleAuthorityMappingController extends BaseController<RoleAuthorityMappingPO, RoleAuthorityMappingQO> {
    ...
    @PostMapping("insert")
    public CommonResult insert(@RequestBody RoleAuthorityMappingPO t) {
        return roleAuthorityMappingService.insert(t);
    }

    @ApiOperation(value = "通用删除逻辑", httpMethod = "GET", notes = "通用删除逻辑")
    @PostMapping("delete")
    public CommonResult delete(RoleAuthorityMappingQO q) {
        return roleAuthorityMappingService.delete(q);
    }

    @ApiOperation(value = "逻辑删除", httpMethod = "GET", notes = "逻辑删除")
    @PostMapping("logicdelete")
    public CommonResult logicDelete(RoleAuthorityMappingQO q) {
        return roleAuthorityMappingService.logicDelete(q);
    }

    @ApiOperation(value = "通用更新逻辑", httpMethod = "POST", notes = "通用更新逻辑")
    @PostMapping("update")
    public CommonResult update(@RequestBody RoleAuthorityMappingPO t) {
    ...
    @PostMapping("get")
    public CommonResult<RoleAuthorityMappingPO> get(RoleAuthorityMappingQO q) {
